export const FREE_LLM_CANDIDATES = Object.freeze([
  ...
  Object.freeze({ provider: 'openrouter', id: 'nex-agi/nex-n2.5-pro:free', structuredOutput: true, schemaEnforcement: 'provider-and-local', reasoningMode: 'none', requiresLivePricingValidation: true }),
  Object.freeze({ provider: 'openrouter', id: 'nvidia/nemotron-3-super-120b-a12b:free', structuredOutput: true, schemaEnforcement: 'provider-and-local', reasoningMode: 'none', requiresLivePricingValidation: true }),
...
export function configuredCandidates(env = process.env) {
  const ids = {
    ...
    openrouter: [env.OPENROUTER_FREE_PRIMARY || 'qwen/qwen3.8-27b:free', env.OPENROUTER_FREE_SECONDARY || 'google/gemma-4-26b-a4b-it:free', env.OPENROUTER_FREE_TERTIARY || 'nex-agi/nex-n2.5-pro:free', env.OPENROUTER_FREE_QUATERNARY || 'nvidia/nemotron-3-super-120b-a12b:free', env.OPENROUTER_FREE_ROUTER || 'openrouter/free'],
  }
